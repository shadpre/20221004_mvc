...
public class MainViewController {
    ...
    @FXML  void openUserInfo(ActionEvent actionEvent)  throws  IOException {
        Stage stage = new Stage();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/userInfoView.fxml"));
        loader.setController( new UserInfoViewController());
        Parent root = loader.load();

        UserInfoViewController u = (UserInfoViewController)  loader.getController();
        Scene scene = new Scene(root, 300,275);
        stage.setTitle("MVC Example App");
        stage.getIcons().add(new Image(getClass().getResource("/img/EdenCodingIcon.png").toExternalForm()));
        stage.setScene(scene);
